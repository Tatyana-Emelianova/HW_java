...
//1.Сохранить в файл строку и загрузить из файла строку с выводом в консоль используя классы FileWriter и FileReader
        try {
            ...
            fw.append("Петров А. Н." + " 23" + " Мужской" + "\n");
            fw.append("Иванов Б. Б." + " 45" + " Мужской" + "\n");
            fw.append("Сидоров В. В." + " 12" + " Мужской" + "\n");
            fw.append("Сергеева К. В." + " 33" + " Женский" + "\n");
            fw.append("Федорова В. К." + " 34" + " Женский" + "\n");
            fw.flush();
